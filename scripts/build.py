  ...
  <div class="login-pane" data-pane="signup" hidden>
    ...
    <form class="login-form" id="signupForm">
      ...
      <div class="form-group">
        ...
        <input type="text" name="inn" id="signupInn" required placeholder="10 или 12 цифр" maxlength="12" inputmode="numeric" pattern="[0-9]+" />
        <div class="form-hint inn-msg" id="signupInnMsg"></div>
      </div>
      <div class="form-group">
      ...
      <label class="form-agree" style="display:flex;align-items:flex-start;gap:10px;font-size:13px;color:var(--slate-600);line-height:1.5;margin:4px 0 14px;cursor:pointer">
        <input type="checkbox" id="signupAgree" required style="width:18px;height:18px;flex-shrink:0;margin-top:1px;accent-color:#3D5C19;cursor:pointer" />
        <span>Я согласен с <a href="/offer.html" target="_blank">офертой</a>, <a href="/regulations.html" target="_blank">пользовательским соглашением</a> и <a href="/policy.html" target="_blank">политикой конфиденциальности</a>, и даю согласие на обработку персональных данных.</span>
      </label>
      <button class="btn btn-primary btn-lg btn-block" type="submit" id="signupSubmit" disabled>Создать аккаунт {icon('arrow-sm')}</button>
...
<script src="/assets/js/inn-validate.js?v={BUILD_ID}"></script>
  ...
  <div class="how-grid">
    ...
    <div class="steps-grid">
      ...
      <div class="step">
        ...
        <p>Платформа ведёт коммуникацию между сторонами, а логистика решается в едином окне.</p>
      </div>
    </div>
  </div>
</section>
...
def build_offer():
    return legal_page('offer', 'Публичная оферта', [
        ('p', 'Настоящий документ является публичной офертой (далее — «Оферта») Общества с ограниченной ответственностью «Русский урожай» (ИНН 5262253008, ОГРН 1105262005023) (далее — «Платформа») и содержит все существенные условия оказания услуг информационного посредничества на онлайн-площадке «Русский Урожай» (russian-harvest.ru).'),
        ...
        ('h2', '6. Реквизиты'),
        ('p', 'ООО «Русский урожай» · ИНН 5262253008 · ОГРН 1105262005023 · 606121, Нижегородская обл., г. Ворсма, ул. Гагарина, д. 21а'),
...
def build_policy():
    return legal_page('policy', 'Политика конфиденциальности', [
        ('p', 'Дата вступления в силу: 22 декабря 2025 года'),
        ('h2', '1. Общие положения'),
        ('p', 'Настоящая Политика конфиденциальности персональных данных (далее — Политика конфиденциальности) действует в отношении всей информации, которую сайт Компании, расположенный на доменном имени http://russian-harvest.ru, может получить о Пользователе во время использования сайта Компании, программ и продуктов Компании.'),
        ('p', 'Настоящая Политика составлена в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Обществом с ограниченной ответственностью «Русский урожай», расположенного по адресу 606121, Нижегородская обл., Павловский р., г. Ворсма, ул. Гагарина, д. 21а, кв. 9, ИНН 5262253008 ОГРН 1105262005023 (далее — Оператор).'),
        ('ul', [
            'Настоящая Политика применяется ко всей информации, которую Оператор может получить о пользователях Сайта при использовании Сайта, сервисов, программ и продуктов Оператора.',
            'Использование Пользователем сайта Компании означает согласие с настоящей Политикой конфиденциальности и условиями обработки персональных данных Пользователя.',
            'В случае несогласия с условиями Политики конфиденциальности Пользователь должен прекратить использование сайта Компании.',
            'Настоящая Политика конфиденциальности применяется только к сайту Компании.',
            'Компания не контролирует и не несёт ответственность за сайты третьих лиц, на которые Пользователь может перейти по ссылкам, доступным на сайте Компании.',
            'Администрация сайта Компании не проверяет достоверность персональных данных, предоставляемых Пользователем сайта Компании.',
        ]),
        ...
        ('p', 'Обработка персональных данных — любое действие или совокупность действий, совершаемых с использованием средств автоматизации или без, включая сбор, запись, систематизацию, накопление, хранение, уточнение, извлечение, использование, передачу, обезличивание, блокирование, удаление, уничтожение персональных данных.'),
        ('p', 'Оператор — Общество с ограниченной ответственностью «Русский урожай», расположенное по адресу 606121, Нижегородская обл., Павловский р., г. Ворсма, ул. Гагарина, д. 21а, кв. 9, ИНН 5262253008 ОГРН 1105262005023, являющееся оператором персональных данных. Персональные данные — любая информация, относящаяся прямо или косвенно к определённому или определяемому Пользователю веб-сайта. Пользователь — любой посетитель веб-сайта.'),
        ('h2', '3. Основные права и обязанности Оператора'),
        ('p', 'Оператор имеет право: получать от субъекта достоверную информацию и/или документы, содержащие персональные данные; продолжить обработку в случаях, указанных в Законе; самостоятельно определять состав мер для обеспечения выполнения обязанностей.'),
        ('ul', [
            ...
            'Обеспечить хранение персональных данных граждан РФ с использованием баз данных на территории РФ.',
            'Рассматривать обращения субъектов в срок не более 30 календарных дней с даты получения.',
        ]),
        ('h2', '4. Основные права и обязанности субъектов персональных данных'),
        ('p', 'Субъекты имеют право получать информацию об обработке своих данных, требовать уточнения, блокирования или уничтожения данных, отозвать согласие, обжаловать действия Оператора. Субъекты обязаны предоставлять достоверные данные и сообщать об их изменении.'),
        ('h2', '5. Персональные данные, обрабатываемые Оператором'),
        ('p', 'Фамилия, имя, отчество, электронный адрес, телефонный номер. Обработка с использованием метрических систем Яндекс Метрика и Top.Mail: IP-адрес, информация из cookies, информация о браузере, время доступа, адрес страницы, реферер.'),
        ('p', 'В рамках регистрации юридических лиц и индивидуальных предпринимателей Оператор также обрабатывает сведения о компании (юридическое наименование, юридический адрес, ИНН, ОГРН, банковские реквизиты, ОКВЭД).'),
        ('h2', '6. Цели обработки персональных данных'),
        ('ul', [
            'Идентификация Пользователя для осуществления обратной связи.',
            'Предоставление доступа к персонализированным ресурсам Сайта.',
            'Установление обратной связи, направление уведомлений, обработка запросов и заявок.',
            'Определение места нахождения для безопасности и предотвращения мошенничества.',
            'Предоставление клиентской и технической поддержки.',
            'Предоставление с согласия Пользователя обновлений, специальных предложений, новостной рассылки.',
        ]),
        ('h2', '7. Принципы обработки персональных данных'),
        ('p', 'Обработка осуществляется на законной и справедливой основе, ограничивается достижением конкретных целей. Обрабатываются только данные, отвечающие целям обработки. Хранение осуществляется не дольше, чем требуют цели обработки.'),
        ('h2', '8. Перечень действий с персональными данными'),
        ('p', 'Оператор осуществляет сбор, запись, систематизацию, накопление, хранение, уточнение, извлечение, использование, передачу, обезличивание, блокирование, удаление и уничтожение персональных данных, в том числе автоматизированную обработку.'),
        ('h2', '9. Правовые основания обработки'),
        ('p', 'Уставные документы Оператора; согласие Пользователя; договор между Оператором и субъектом; нормативно-правовые акты, регулирующие сферу защиты персональных данных.'),
        ('h2', '10. Порядок сбора, хранения, передачи и обработки'),
        ('p', 'Согласие может быть выражено путём проставления отметки («галочки») в соответствующем поле на Сайте, продолжения использования Сайта, предоставления данных при заполнении форм, заключения договора. Передача третьим лицам осуществляется на основании договора и с согласия субъекта. Передача персональных данных также осуществляется через API-сервисы, зарегистрированные на территории РФ, где используется ИНН участников при регистрации.'),
        ('p', 'Для актуализации данных или отзыва согласия Пользователь направляет уведомление на info@russian-harvest.ru с соответствующей пометкой.'),
        ('h2', '11. Конфиденциальность персональных данных'),
        ('p', 'Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта, если иное не предусмотрено федеральным законом.'),
        ('h2', '12. Трансграничная передача персональных данных'),
        ('p', 'Оператор до начала трансграничной передачи обязан убедиться в надёжной защите прав субъектов на территории иностранного государства. Передача в государства, не отвечающие требованиям, осуществляется только при наличии письменного согласия субъекта.'),
        ('h2', '13. Заключительные положения'),
        ('p', 'Пользователь может получить разъяснения, обратившись по адресу info@russian-harvest.ru. Оператор вправе вносить изменения в Политику в любое время без предварительного уведомления. Новая редакция вступает в силу с момента размещения на Сайте. Пользователь обязуется самостоятельно отслеживать изменения. До обращения в суд обязательно предъявление претензии; получатель претензии в течение 30 календарных дней письменно уведомляет заявителя о результатах рассмотрения.'),
    ])
  ...
  <div class="account-layout">
    ...
    <aside class="account-aside">
      <div class="account-user">
        ...
        <div class="company" id="accCompany">ООО «Русский урожай»</div>
